...
def train_source(args):
    ...
    while iter_num < max_iter:
        ...
        outputs_sourceg = torch.stack([outputs_source, outputs_source_m1], 2)
        ...
        outputs_sourceg = torch.stack([outputs_source_m1, outputs_source], 2)
        outputs_sourceg = netG(outputs_sourceg)
        outputs_sourceg = torch.squeeze(outputs_sourceg,2)
        ...
        if iter_num % interval_iter == 0 or iter_num == max_iter:
            ...
            if args.dset=='VISDA-C':
                acc_s_te, acc_list = cal_acc(dset_loaders['source_te'], netF, netB1, netC1, True)
                log_str = 'Task: {}, Iter:{}/{}; Accuracy = {:.2f}%'.format(args.name_src, iter_num, max_iter, acc_s_te) + '\n' + acc_list
            else:
                acc_s1_te, _ = cal_acc(dset_loaders_s1['source_te'], netF, netB1, netC1, False)
                acc_g1_te, _ = cal_globe(dset_loaders_s1['source_te'], netF, netB1, netC1, netB2, netC2, netG, False)                
                ...
                acc_g2_te, _ = cal_globe(dset_loaders_s2['source_te'], netF, netB1, netC1, netB2, netC2, netG, False)
...
def test_target(args):
    ...
    if args.da == 'oda':
        acc_os1, acc_os2, acc_unknown = cal_acc_oda(dset_loaders_t['test'], netF, netB1, netC1)
        ...
        if args.dset=='VISDA-C':
            ...
            accg, _ = cal_globe(dset_loaders_t['test'], netF, netB1, netC1, netB2, netC2, netG, False)
            log_str = '\nTraining: {}, Task: {}, Accuracy_s1 = {:.2f}%\tAccuracy_s2 = {:.2f}%\tGlobe = {:.2f}%'.format(args.trte, args.task, acc1, acc2, accg)
